          ...
          if (
            (a >= p - 1e-7 && a >= 0
              ? ((this._totalTime = p),
                ...
                this._reversed ||
                  ((e = !0), (f = 'onComplete'), (d = d || this._timeline.autoRemoveChildren)),
                0 === t &&
                    ...
                    this._yoyo &&
                      ...
                      o &&
                        (this._yoyoEase ||
                          (o !== !0 || this._initted
                            ? (this._yoyoEase = o =
                                o === !0 ? this._ease : o instanceof Ease ? o : Ease.map[o])
                            : ((o = this.vars.ease),
                              (this._yoyoEase = o =
                                o
                                  ? o instanceof Ease
      ...
      function (a, b, c) {
        ...
        return (
          ...
          (q._parseTimeOrLabel = function (b, c, d, e) {
            ...
            if (
              ((f = this.duration() > 99999999999 ? this.recent().endTime(!1) : this._duration),
              'string' == typeof c)
            )
        ...
        var k,
          ...
          U = (function () {
            var a = T.indexOf('Android'),
              b = P('a');
            return ((m = -1 !== T.indexOf('Safari') &&
            -1 === T.indexOf('Chrome') &&
            (-1 === a || parseFloat(T.substr(a + 8, 2)) > 3)), (o = m && parseFloat(T.substr(T.indexOf('Version/') + 8, 2)) < 6), (n = -1 !== T.indexOf('Firefox')), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(T) ||
              /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(T)) &&
              (p = parseFloat(RegExp.$1)), b ? ((b.style.cssText = 'top:1px;opacity:.55;'), /^0.55/.test(b.style.opacity)) : !1);
          })(),
          V = function (a) {
            return x.test(
              'string' == typeof a
                ...
                ? (g.l++,
                  ...
                  h > 0
                    ? ((g.data['xn' + h] = b + c),
                      ...
                      (g['xn' + h] = b),
                      g.plugin ||
                        ((g.xfirst = new ta(g, 'xn' + h, b, c, g.xfirst || g, 0, g.n, e, g.pr)),
                        (g.xfirst.xs0 = 0)),
                      g)
        ...
        var Aa,
          ...
          Qa = function (a, b) {
            ...
            for (e = (d || '').match(s) || [], wa = e.length; --wa > -1; )
              (f = Number(e[wa])),
                (e[wa] = (g = f - (f |= 0)) ? ((g * j + (0 > g ? -0.5 : 0.5)) | 0) / j + f : f);
                  ...
                  return void (B || P || L
                    ? ((B *= K),
                      ...
                      x &&
                        ...
                        (g *= b),
                        O &&
                          ((b = Math.tan(O * K)), (b = Math.sqrt(1 + b * b)), (c *= b), (f *= b))),
                      L &&
                ...
                return (
                  ...
                  (E || (Fa && n && D.zOrigin)) &&
                    (Ca
                      ...
                      : ha(E + '', D)),
                  o &&
                    (d._transformType = (D.svg && Aa) || (!n && 3 !== this._transformType) ? 2 : 3),
                  j && (i[c] = j),
                  k && (i.scale = k),
                  f
                );
          ...
          if (
            ...
            if ('all' === this.e) (g.cssText = ''), (e = !0);
              ...
              for (b = this.e.split(' ').join('').split(','), d = b.length; --d > -1; )
                (c = b[d]),
                  i[c] &&
                    (i[c].parse === h ? (e = !0) : (c = 'transformOrigin' === c ? Ea : i[c].p)),
                  Va(g, c);
            e &&
              (Va(g, Ca),
            ...
            for (g in b) {
              if (((n = b[g]), 'function' == typeof n && (n = n(r, q)), (h = i[g])))
                ...
                (m = _(a, g, e) + ''),
                  ...
                  (s && A.test(n))
                    ? (s ||
                        ((n = na(n)), (n = (n.length > 3 ? 'rgba(' : 'rgb(') + n.join(',') + ')')),
    ...
    if (!e.TweenLite) {
      ...
      var u = [0, 0, 1, 1],
        ...
        x = (v.register = function (a, b, c, d) {
          for (
            ...
            for (
              f = i[j], e = d ? t('easing.' + f, null, !0) : l.easing[f] || {}, g = k.length;
              --g > -1;
      ...
      (h = y.prototype),
        (h.addEventListener = function (a, b, c, d, e) {
          ...
          var f,
            ...
            k = 0;
          for (
            this !== i || j || i.wake(), null == h && (this._listeners[a] = h = []), g = h.length;
            --g > -1;
      ...
      t('Ticker', function (a, b) {
        ...
        y.call(k),
          ...
          (k.sleep = function () {
            null != f &&
              (n && A ? A(f) : clearTimeout(f), (e = o), (f = null), k === i && (j = !1));
          }),
          (k.wake = function (a) {
        ...
        (h.eventCallback = function (a, b, c, d) {
          if ('on' === (a || '').substr(0, 2)) {
            ...
            null == b
              ...
              : ((e[a] = b),
                (e[a + 'Params'] =
                  p(c) && -1 !== c.join('').indexOf('{self}') ? this._swapSelfInParams(c) : c),
                (e[a + 'Scope'] = d)),
      ...
      var G = t(
          ...
          function (b, c, d) {
            ...
            if (
              ((this._overwrite = i =
                null == i ? V[G.defaultOverwrite] : 'number' == typeof i ? i >> 0 : V[i]),
              (h || b instanceof Array || (b.push && p(b))) && 'number' != typeof b[0])
            )
              for (
                this._targets = g = n(b), this._propLookup = [], this._siblings = [], e = 0;
                e < g.length;
                e++
              )
                (f = g[e]),
      ...
      (h._init = function () {
        ...
        (G.from = function (a, b, c) {
          return (
            (c.runBackwards = !0), (c.immediateRender = 0 != c.immediateRender), new G(a, b, c)
          );
        }),
