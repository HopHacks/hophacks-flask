(function () {
  window.CanvasSlideshow = function (options) {
    ...
    // const textureButtonOver = PIXI.Texture.from('register-button.png');
    ...
    this.loadPixiSprites = function (sprites) {
      ...
      for (var i = 0; i < rSprites.length; i++) {
        ...
        // if (rTexts) {
        if (i == 0) {
          // var text1 = new PIXI.Text("HOPHACKS", style1);
          // var text2 = new PIXI.Text("SEPTEMBER 16-18", style2);

          // image.addChild(text1);
          // image.addChild(text2);

          // text1.anchor.set(0.5);
          // text1.x = image.width / 2;
          // text1.y = image.height / 2;

          // text2.anchor.set(0.5);
          // text2.x = image.width / 2;
          // text2.y = image.height / 2 + 100;

          button.anchor.set(0.5);
          button.x = renderer.width / 2;
          // button.y = renderer.height / 2 + 160;
        ...
        // var richText = new PIXI.Text( rTexts[i], style1);
