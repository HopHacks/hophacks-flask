  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md text-black w-full h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-1 min-h-0 space-y-2">
        ...
        <p className="text-sm">
          <strong>Major:</strong> <span className="truncate">{profile.major}</span>
        </p>
          ...
          <div className="flex flex-wrap gap-1 mt-1">
            ...
            {profile.preferred_roles?.length > 3 && (
              <span className="text-xs text-gray-500">
                +{profile.preferred_roles.length - 3} more
              </span>
            )}
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0">
          ...
          <div
            className="text-xs leading-relaxed overflow-hidden text-ellipsis"
            style={{
              display: '-webkit-box',
              WebkitLineClamp: 4,
