          ...
          <Grid className={classes.team} container>
            ...
            <div className={classes.teambox}>
              <MemberItem
                ...
                memberTitle="Design"
                linkedin="https://www.linkedin.com/mwlite/in/jiayi-elaine-he"
              />
            </div>
          </Grid>
        )}
          ...
          <Grid className={classes.team} container>
            <div className={classes.teambox}>
              <MemberItem
                ...
                linkedin="https://www.linkedin.com/in/alan-li-a45aa7197/"
              />
            </div>
            <div className={classes.teambox}>
              <MemberItem
                imgURL="NicholasBowen"
                memberName="Nicholas Bowen"
                memberTitle="Website"
