...
const faqData = [
  ...
  },
  {
    ...
    answer: (
      <>
        This year, HopHacks is held at Hodson Hall and the Glass Pavilion on the Johns Hopkins Homewood Campus in Baltimore, MD. A campus map can be found{' '}
        <a
          className={linkClass}
  ...
  },
  {
    ...
    answer: (
      <>
        We will not be offering individual travel reimbursements. However, please see the busing interest form in our{' '}
        <a
          className={linkClass}
        ...
        {' '}to sign up for updates. If enough people from your city sign up, we may send a FREE bus to pick up hackers in your area!
      </>
    ),
  },
  {
