...
// Ported from frontend-old/public/data/teams.json (2025-26 roster).
    ...
    members: [
      {
        ...
        funFact:
          "I have synesthesia (so I associate colors with letters and numbers)/Discord light mode is superior",
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        funFact:
          "Does the NYTimes Mini Crossword daily (but not very good at it).",
        major: "Computer Science & Public Health",
        year: "2026",
      },
    ],
  },
    ...
    members: [
      {
        ...
        funFact: "I have hiked to the highest point in Edinburgh, Scotland",
        major: "Computer Science/AMS",
        year: "2027",
      },
      {
        name: "Chelsea Wong",
      ...
      },
      {
        ...
        funFact:
          "warm boba with 0% sugar and brown sugar boba pearls are the best!",
        major: "AMS/CS",
        year: "2028",
      },
    ],
    ...
    members: [
      {
        ...
        funFact: "I've held a human brain \u{1F9E0}",
        major: "Electrical Engineering & Neuroscience",
        year: "2028",
      },
      {
    ...
    members: [
      {
        ...
        funFact:
          "Lost more than five water bottles in the past few years, so bought three identical ones on Black Friday. Spoiler: one is already gone.",
        major: "Computer Science",
        year: "2026",
      },
      {
